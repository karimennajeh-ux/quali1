...
$g.DrawString("Etape 4 - Diffuser aux autres appareils", $titleFont, $accent, 64, 52)
...
$g.DrawString("4 / 4", (New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Bold)), ([System.Drawing.Brushes]::White), 1048, 48)
...
$outFile = Join-Path $PSScriptRoot "step4_diffuser_reseau.png"
